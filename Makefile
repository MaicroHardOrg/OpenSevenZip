...
package-github:
	$(MAKE) package-variant INFO_PLIST="$(GITHUB_INFO_PLIST)" APP_ENTITLEMENTS="$(GITHUB_ENTITLEMENTS)" HELPER_ENTITLEMENTS="$(GITHUB_ENTITLEMENTS)" SWIFT_FLAGS=""

package-appstore:
	$(MAKE) package-variant INFO_PLIST="$(APPSTORE_INFO_PLIST)" APP_ENTITLEMENTS="$(APPSTORE_ENTITLEMENTS)" HELPER_ENTITLEMENTS="$(APPSTORE_HELPER_ENTITLEMENTS)" SWIFT_FLAGS="-Xswiftc -DAPP_STORE"
